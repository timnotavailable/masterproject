## adapted from  Fast Fourier Convolution   Lu Chi, Borui Jiang, Yadong Mu  https://github.com/pkumivision/FFC
## modified due to torch library has altered
## all the maxpool-->adaptive average pooling (1x1)
## global units has been changed, convolve with pm1,pm2,apm1,apm2
## still using local units
##change the stride of basicblock
##screen the maxpool2D in the first block
## change the calculation way of local units
