...
#         nis_seg=np.fromfile(file, np.float32, 15 * 36)
#         polarmaps=np.reshape(polarmaps,(3,256,256))
      ...
      ###reshape
        ...
        polarmaps=np.reshape(polarmaps,(3,256,256))
#         nis_seg = np.reshape(nis_seg,(15,36))       
       ### Transform
...
#         pm2=pm2/2000000
#         pm3=rescale_transform(pm3)
#         apm1=rescale_transform(apm1)/100
#         apm2=rescale_transform(apm2)/100
...
#             'nis_seg':nis_seg,
    ...
    def add_gaus_noise(self,mean=0,sigma=0.05):
        ...
        noise_apm1=np.random.normal(mean,sigma,size=(15, 36))
        self.apm1+=noise_apm1 
        
        shape=np.shape(self.apm2)
        
        noise_apm2=np.random.normal(mean,sigma,size=shape)
        self.apm2+=noise_apm2
