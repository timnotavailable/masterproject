...
from models.Classifiers import FFC_res18
...
@hydra.main(config_path="config/train",config_name="stress_FFC_res18.yaml")   
def train_model(cfg:DictConfig):
    ...
    optimizer=optim.SGD(classifier.parameters(),lr=cfg.optimizer.lr)
