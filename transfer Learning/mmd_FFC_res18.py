...
from models.Classifiers import mmd_FFC_res18
...
@hydra.main(config_path="config/train",config_name="mmd_FFC_Res18.yaml")   
def train_model(cfg:DictConfig):
    ...
    classifier=Classifier(pretrained_path,alpha=cfg.model.alpha).to(device)
